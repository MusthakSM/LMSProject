    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link active" href="#">All Admins</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link" href="AddAdmin.php">Add Admin</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link" href="RemoveAdmin.php">Remove Admin</a>
                        </li>
                    </ul>
                </div>                
            </div>
        ...
        <div class="container-fluid d-flex flex-column min-vh-100" style="padding-right: 0; padding-left: 0;">
            ...
            <?php
                ...
                $sq1 = "SELECT Admin_Id, Admin_Name, Admin_Mail, Starting_Date FROM LIBRARIAN";
                ...
                if ($stmt) {
                    ...
                    $stmt->bind_result($adminId, $adminName, $adminMail, $startingDate);

                    echo '<div class="container mt-5">';
                    // Fetch the data and print the resulting table
                    echo '<table class="table table-dark table-striped" style="font-size: 18px;">';
                    echo '<thead><tr><th class="text-center">Admin ID</th><th class="text-center">Name</th><th class="text-center">Email</th><th class="text-center">Starting Date</th></tr></thead>';
                    echo '<tbody>';                    
                    while ($stmt->fetch()) {
                        echo '<tr>';
                        echo '<td class="text-center">' . $adminId . '</td>';
                        echo '<td class="text-center">' . $adminName . '</td>';
                        echo '<td class="text-center">' . $adminMail . '</td>';
                        echo '<td class="text-center">' . $startingDate . '</td>';
                        echo '</tr>';
                    }
                    echo '</tbody>';
                    echo '</table>';
