            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav nav-pills">
                        ...
                        <li class="nav-item">
                        <a class="nav-link active" href="#">Deactivate Member</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container-fluid d-flex flex-column min-vh-100" style="padding-right: 0; padding-left: 0;">
            ...
            <div class="container mt-5" style="margin-right: auto; margin-left: auto; max-width: 500px;">
                <div class="container mt-3 mb-3 text-center text-bg-danger">
                    <div class="h1">DEACTIVATE MEMBER</div>
                </div>

                <!-- Form Element.. -->
                <form action="DeactivateAction.php" method="POST" style="margin-right: auto; margin-left:auto" class="was-validated">
                    
                    <div class="mb-3 mt-3">
                        <label for="id" class="form-label">Member ID:</label>
                        <input type="text" class="form-control" id="id" placeholder="Enter the Admin ID" name="id" required>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary mt-2">Deactivate</button>
                </form>
            </div>
