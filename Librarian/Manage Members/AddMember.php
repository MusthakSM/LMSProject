    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link" href="AllMembers.php">All Members</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link active" href="#">Add Member</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container-fluid d-flex flex-column min-vh-100" style="padding-right: 0; padding-left: 0;">
            ...
            <div class="container mt-5" style="margin-right: auto; margin-left: auto; max-width: 500px;">
                ...
                <!-- Form Element.. -->
                <form action="AddMemberAction.php" method="POST" style="margin-right: auto; margin-left:auto" class="was-validated">

                    <div class="mb-3 mt-3">
                        <label for="fname" class="form-label">First Name:</label>
                        <input type="text" class="form-control" id="fname" placeholder="Enter the First name" name="fname" required>
                    </div>
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" class="form-control" id="nic" placeholder="Enter the NIC" name="nic" required>
                    </div>

                    <div class="mb-3 mt-3">
                        <label for="address" class="form-label">Current Address:</label>
                        <input type="text" class="form-control" id="address" placeholder="Enter the current Address" name="address" required>
                    </div>

                    <div class="mb-3 mt-3">
                        <label for="cnum" class="form-label">Contact Number:</label>
                        <input type="text" class="form-control" id="cnum" placeholder="Enter the Contact Number" name="cnum" required>
                    </div>
                    
                    <div class="mb-3 mt-3">
                        <label for="mail" class="form-label">E-mail:</label>
                        <input type="text" class="form-control" id="mail" placeholder="Enter the E-mail" name="mail" required>
                    </div>
