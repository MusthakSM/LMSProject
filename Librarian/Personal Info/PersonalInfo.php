    ...
    <body>
        ...
        <div class="container-fluid d-flex flex-column min-vh-100" style="padding-right: 0; padding-left: 0;">
            ...
            <div class="container" style="width:800px; margin-top:80px">
                <p class="display-5 text-center text-bg-danger"><b>ADMIN INFO</b></p>
                ...
                <div class="row bg-white" style="width:800px; height: 400px;">
                    ...
                    <div class="col-sm-6">
                        <div style="margin-inline-start: 30px; margin-top: 100px;">
                            <p class="h4">Admin Id: <?php echo $Details[0]['Admin_Id']; ?></p>
                            <p class="h4">Name: <?php echo $row['Admin_Name']; ?></p>
                            <p class="h4">Email: <?php echo $row['Admin_Mail']; ?></p>
                            <p class="h4">Starting Date: <?php echo $Details[0]['Starting_Date']; ?></p>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="EditAction.php" method="POST" style="margin-right: auto; margin-left:auto" class="was-validated">
                                        ...
                                        <div class="mb-3 mt-3">
                                            ...
                                            <input type="text" class="form-control" id="name" placeholder="Enter the new name" name="name">
                                        </div>
