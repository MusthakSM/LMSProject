...
<html lang="en">
    <head>
        ...
        <?php
            ...
            $sq1 = "SELECT Book_Id, Title, Edition, Genre, Language, year, Author, BoughtFlag, Bought_Date, Seller_Id FROM BOOK";
            ...
            if ($stmt) {
                ...
                $stmt->bind_result($Book_Id, $Title, $Edition, $Genre, $Language, $Year, $Author, $boughtFlag, $boughtDate, $sellerId);
            ...
            foreach($items as $item){
                if ($item['BoughtFlag'] == 1) {
                    $boughtBooksCount++;
                }
            }

            //Bought books percentage
            $boughtBooksWidthPercentage = ($boughtBooksCount/$totalBooks)*100;
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav nav-pills">
                        <li class="nav-item dropdown">
                            <a class="nav-link active dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Bought</a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="DonatedBooks.php">Donated</a></li>
        ...
        <div class="container-fluid d-flex flex-column min-vh-100" style="padding-right: 0; padding-left: 0;">
            ...
            <div class="container">
                <div class="progress" style="height: 50px;">
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" style="width: <?php echo $boughtBooksWidthPercentage; ?>%; font-size: 20px">
                        Bought(<?php echo $boughtBooksCount; ?>)
                    </div>
                    <div class="progress-bar " style="width: <?php echo 100 - $boughtBooksWidthPercentage; ?>%; font-size: 20px">
                        Donated(<?php echo $totalBooks-$boughtBooksCount; ?>)
                    </div>
                </div>
            </div>
                            ...
                            <div class="card bg-dark mx-auto" style="width: 300px;">
                                ...
                                <div class="card-body">
                                    <div class="card-body text-center text-white">
                                        ...
                                        <p class="card-text">Bought Date: <?php echo $item['Bought_Date']; ?></p>
                                        <p class="card-text">Seller ID: <?php echo $item['Seller_Id']; ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
