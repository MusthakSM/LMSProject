            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link active" href="#">All Sellers</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link" href="AddSellers.php">Add Seller</a>
                        </li>
                    </ul>
                    <form action="SearchSeller.php" method="POST" class="d-flex" style="margin-left: 20px;" target="_blank">
                        <input class="form-control me-2" type="text" placeholder="Seller Id (or) Name" name="key">
        ...
        <div class="container-fluid d-flex flex-column min-vh-100" style="padding-right: 0; padding-left: 0;">
            ...
            <div class="container mt-5" style="margin-right: auto; margin-left: auto; max-width: 500px;">
                <div class="container mt-3 mb-3 text-center text-bg-danger">
                    <div class="h1">SELLERS</div>
                </div>
            </div>


            <!-- php code for retrieve seller details from the database. -->
            <?php
                ...
                $sq1 = "SELECT Seller_Id, Seller_Name, Contact_Num, Contact_Mail, Address FROM SELLER";
                ...
                if ($stmt) {
                    ...
                    $stmt->bind_result($sellerId, $sellerName, $contactNum, $contactMail, $address);

                    echo '<div class="container mt-5">';
                    // Fetch the data and print the resulting table
                    echo '<table class="table table-dark table-striped" style="font-size: 18px;">';
                    echo '<thead><tr><th class="text-center">Seller ID</th><th class="text-center">Name</th><th class="text-center">Contact Number</th><th class="text-center">E-mail</th><th class="text-center">Address</th></tr></thead>';
                    echo '<tbody>';                    
                    while ($stmt->fetch()) {
                        echo '<tr>';
                        echo '<td class="text-center">' . $sellerId . '</td>';
                        echo '<td class="text-center">' . $sellerName . '</td>';
                        echo '<td class="text-center">' . $contactNum . '</td>';
                        echo '<td class="text-center">' . $contactMail . '</td>';
