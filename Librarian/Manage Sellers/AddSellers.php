            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link" href="AllSellers.php">All Sellers</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link active" href="#">Add Seller</a>
                        </li>
                    </ul>
                </div>                
            </div>
        ...
        <div class="container-fluid d-flex flex-column min-vh-100" style="padding-right: 0; padding-left: 0;">
            ...
            <div class="container mt-5" style="margin-right: auto; margin-left: auto; max-width: 500px;">
                <div class="container mt-3 mb-3 text-center text-bg-danger"> 
                    <div class="h1">ADD SELLER</div>
                </div>

                <!-- Form Element.. -->
                <form action="AddSellerAction.php" method="POST" style="margin-right: auto; margin-left:auto" class="was-validated">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="number" class="form-control" id="num" placeholder="Enter the Contact Number" name="num" required>
                    </div>

                    <div class="mb-3 mt-3">
                        <label for="email" class="form-label">E-mail:</label>
                        <input type="text" class="form-control" id="email" placeholder="Enter the E-mail" name="email" required>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary mt-2">Add Seller</button>
                </form>
            </div>
