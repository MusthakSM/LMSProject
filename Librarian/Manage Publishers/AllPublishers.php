            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link active" href="#">All Publishers</a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link" href="AddPublishers.php">Add Publisher</a>
                        </li>
                    </ul>
                    <form action="SearchPublisher.php" method="POST" class="d-flex" style="margin-left: 20px;" target="_blank">
                        <input class="form-control me-2" type="text" placeholder="Publisher Id (or) Name" name="key">
        ...
        <div class="container-fluid d-flex flex-column min-vh-100" style="padding-right: 0; padding-left: 0;">
            ...
            <div class="container mt-5" style="margin-right: auto; margin-left: auto; max-width: 500px;">
                <div class="container mt-3 mb-3 text-center text-bg-danger">
                    <div class="h1">PUBLISHERS</div>
                </div>
            </div>


            <!-- php code for retrieve publisher details from the database. -->
            <?php
                ...
                $sq1 = "SELECT Publisher_Id, Publisher_Name, Contact_Num, Contact_Mail, Address	FROM PUBLISHER";
                ...
                if ($stmt) {
                    ...
                    $stmt->bind_result($publisherID, $publisherName, $contactNum, $contactMail, $address);
                    ...
                    while ($stmt->fetch()) {
                        echo '<tr>';
                        echo '<td class="text-center">' . $publisherID . '</td>';
                        echo '<td class="text-center">' . $publisherName . '</td>';
