...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        //Password
        $member_password = htmlspecialchars(trim($member_password));
        ...
        $stmt->bind_param("sssssisss", $fname, $lname, $dob, $nic, $address, $cNumber, $cMail, $member_username, $member_password);
        if ($stmt->execute()) {
