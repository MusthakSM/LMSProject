...
<html lang="en">
    <head>
        <title>Display Borrowable Books</title>
        <meta charset="utf-8">
        <!-- Bootstrap 5 !-->
        ...
        <?php
            ...
            $sq1 = "SELECT Book_Id, Title, Edition, Genre, Language, year, Author, BorrowFlag FROM BOOK";
            ...
            if ($stmt) {
                ...
                $stmt->bind_result($Book_Id, $Title, $Edition, $Genre, $Language, $Year, $Author, $borrowFlag);
