        ...
        <div class="row px-4 pt-3 pb-3"> 
            ...
            <div class="col-sm-8 pt-4 ">
                <ul class="nav nav-pills justify-content-end" id="my_nav">
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/LMS%20project/home.php">HOME</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/LMS%20project/Display%20Books/AllBooks.php">BOOKS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="#">CONTACTS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost/LMS%20project/About%20us/aboutus.html">ABOUT US</a>
                    </li>
                </ul>
            </div>
        </div>
