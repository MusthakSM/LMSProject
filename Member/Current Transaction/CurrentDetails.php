...
<style>
    ...
    <body>
        ...
        <?php
            ...
            $selectSql = "SELECT Book.Book_ID, Book.Title, Past_Borrows.Borrow_Date, Past_Borrows.Return_Date_Default,Past_Borrows.Return_Date_Act FROM Book, Past_Borrows WHERE Past_Borrows.Member_Id = ? AND Book.Book_ID = Past_Borrows.Book_ID";
            ...
            if ($selectStmt) {
                ...
                $selectStmt->bind_result($Book_Id, $Title, $BorrowDate, $ReturnDate, $ReturnDateAct);

                

                if ($ReturnDateAct == 'NULL'){
                    
                echo '<div class="container mt-5">';
                // Fetch the data and print the resulting table
                echo '<table class="table table-dark table-striped" style="font-size: 13px;">';
                echo '<thead><tr><th class="text-center">BookID</th><th class="text-center">Book Title</th><th class="text-center">Borrowed Date</th><th class="text-center">Return Date</th></tr></thread>';
                echo '<tbody>'; 
