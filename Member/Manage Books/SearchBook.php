                ...
                if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["borrow"])) {
                    ...
                    if ($updateStmt->execute()) {
                        ...
                        if ($insertStmt->execute()) {
                            ...
                            header("Location: http://localhost/lms-project-main/LMS%20project/Member/Manage%20Books/SearchBook.php?");
                            exit();
                        } else {
                            // Error handling
        ...
        <div class="container-fluid d-flex flex-column min-vh-100" style="padding-right: 0; padding-left: 0;">
            ...
            <div class="container" style="margin-top: 30px;">
                ...
                <?php foreach ($items as $item) :
                    ...
                    echo '    <div class="card bg-dark mx-auto" style="width: 270px; height: 700px;">';
