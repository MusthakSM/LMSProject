...
<html lang="en">
    <head>
        ...
        <?php
            ...
            $sq1 = "SELECT Book.Book_Id, Book.Title, Book.Edition, Book.Genre, Book.Language, Book.year, Book.Author, Publisher.Publisher_Name FROM BOOK, PUBLISHER where Book.Publisher_Id = Publisher.Publisher_ID";
            ...
            if ($stmt) {
                ...
                $stmt->bind_result($Book_Id, $Title, $Edition, $Genre, $Language, $Year, $Author, $Publisher);
    ...
    <body>
        ...
        <div class="container-fluid d-flex flex-column min-vh-100" style="padding-right: 0; padding-left: 0;">
            ...
            <div class="container mt-5" style="margin-right: auto; margin-left: auto; max-width: 1100px;">
                <div class="container mt-3 mb-3 text-center text-bg-danger">
                    <div class="h1">BOOKS THAT ARE AVAILABLE(BORROW / REFERENCE)</div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="progress" style="height: 50px;">
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" style="width: 100%; font-size: 20px">
                    ...
                    <?php foreach ($items as $item) :?>
                        <div class="col-md-3 mb-3">
                            <div class="card bg-dark mx-auto" style="width: 270px; height: 700px;">
                                <img class="card-img-top" src=<?php echo "http://localhost/lms-project-main/LMS%20project/Book_Images/" . str_replace('+', '%20', urlencode($item['Title']))  . ".png";?> alt="Card image" style="width:100%" >
                                <div class="card-body">
